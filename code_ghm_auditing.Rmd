...
```{r only_global, cache=TRUE, dependson="unc_oat", fig.height=2.1, fig.width=3.1}
...
```{r all_figures_comment, cache=TRUE, fig.height=4.2, fig.width=4}
...
```{r his_unc, cache=TRUE, fig.height=2, fig.width=3}
