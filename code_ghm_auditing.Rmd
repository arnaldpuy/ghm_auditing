---
title: "Why global irrigation water withdrawal estimates are dangerously wrong"
subtitle: "R code"
author: "Arnald Puy"
header-includes:
...
This document presents the workflow of the Comment "Why global irrigation water withdrawal estimates are dangerously wrong", by A. Puy, R. Sheikholeslami, H. V. Gupta, J. W. Hall, S. Lo Piano, J. Meier, F. Pappenberger, A. Porporato, G. Vico, and A. Saltelli.

Questions about the code or the computational design should be addressed to A. Puy (\href{mailto:apuy@princeton.edu}{apuy@princeton.edu}, or \href{mailto:arnald.puy@pm.me}{arnald.puy@pm.me}).
...
## Uncertainty in the extension of irrigated areas in Uvalde, Texas
...
```{r oat_matrix, cache=TRUE, dependson=c("sample_matrix_full", "run_model")}
...
```{r model_oat, cache=TRUE, dependson=c("oat_matrix", "run_model")}
...
```{r unc_oat, cache=TRUE, dependson=c("model_oat", "settings_full", "sample_matrix_full"), fig.height=3, fig.width=4.5}
...
```{r all_figures_comment, cache=TRUE, fig.height=4.5, fig.width=4.5}
